#ifndef __TOMATOS_STIVALE2_H__
#define __TOMATOS_STIVALE2_H__
...
typedef struct stivale2_tag {
    uint64_t identifier;
    uint64_t next;
} __attribute__((__packed__)) stivale2_tag_t;
...
typedef struct stivale2_header {
    ...
    uint64_t flags;
    uint64_t tags;
} __attribute__((__packed__)) stivale2_header_t;
...
} __attribute__((__packed__)) stivale2_header_tag_framebuffer_t;
...
typedef struct stivale2_header_tag_smp {
    stivale2_tag_t tag;
    uint64_t flags;
} __attribute__((__packed__)) stivale2_header_tag_smp_t;
...
#define STIVALE2_BOOTLOADER_VERSION_SIZE 64
    ...
    uint64_t tags;
} __attribute__((__packed__)) stivale2_struct_t;
...
typedef struct stivale2_struct_tag_cmdline {
    stivale2_tag_t tag;
    uint64_t cmdline;
} __attribute__((__packed__)) stivale2_struct_tag_cmdline_t;
...
typedef struct stivale2_mmap_entry {
    ...
    uint32_t type;
    uint32_t unused;
} __attribute__((__packed__)) stivale2_mmap_entry_t;

typedef struct stivale2_struct_tag_memmap {
    stivale2_tag_t tag;
    uint64_t entries;
    struct stivale2_mmap_entry memmap[];
} __attribute__((__packed__)) stivale2_struct_tag_memmap_t;
...
} __attribute__((__packed__)) stivale2_struct_tag_framebuffer_t;
...
} __attribute__((__packed__)) stivale2_module_t;

typedef struct stivale2_struct_tag_modules {
    stivale2_tag_t tag;
    uint64_t module_count;
    struct stivale2_module modules[];
} __attribute__((__packed__)) stivale2_struct_tag_modules_t;
...
typedef struct stivale2_struct_tag_rsdp {
    stivale2_tag_t tag;
    uint64_t rsdp;
} __attribute__((__packed__)) stivale2_struct_tag_rsdp_t;
...
typedef struct stivale2_struct_tag_epoch {
    stivale2_tag_t tag;
    uint64_t epoch;
} __attribute__((__packed__)) stivale2_struct_tag_epoch_t;
...
typedef struct stivale2_struct_tag_firmware {
    stivale2_tag_t tag;
    uint64_t flags;
} __attribute__((__packed__)) stivale2_struct_tag_firmware_t;
...
} __attribute__((__packed__)) stivale2_smp_info_t;
...
} __attribute__((__packed__)) stivale2_struct_tag_smp_t;
...
typedef struct stivale2_struct_tag_pxe_server_info {
    stivale2_tag_t tag;
    uint32_t server_ip;
} __attribute__((__packed__)) stivale2_struct_tag_pxe_server_info_t;

/**
 * The stivale2 struct global instance
 */
extern struct stivale2_struct* g_stivale2_struct;
