...
static error_t dsdt_init() {
    ...
    // map it
    CHECK_AND_RETHROW(vmm_map_direct((uintptr_t)dsdt - DIRECT_MAPPING_BASE, KB(4)));
    CHECK_AND_RETHROW(vmm_map_direct((uintptr_t)dsdt - DIRECT_MAPPING_BASE, dsdt->length));
