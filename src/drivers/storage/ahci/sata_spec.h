#ifndef TOMATKERNEL_SATA_SPEC_H
#define TOMATKERNEL_SATA_SPEC_H
...
} __attribute__((__packed__)) ATA_IDENTIFY_DATA;
_Static_assert(sizeof(ATA_IDENTIFY_DATA) == 512, "size mismatch");

#endif //TOMATKERNEL_SATA_SPEC_H
